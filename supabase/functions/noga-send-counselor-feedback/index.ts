...
<head>
  ...
  <title>Essay Feedback from Your Consultant</title>
</head>
          ...
          <tr>
            <td style="padding:40px;">
              ...
              <p style="margin:0 0 16px;color:#374151;font-size:16px;line-height:1.7;">
                Your consultant <strong>${counselorName}</strong> has reviewed your essay and left feedback for you.
              </p>
          ...
          <tr>
            <td style="background:#f9fafb;border-top:1px solid #e5e7eb;padding:20px 40px;text-align:center;">
              <p style="margin:0;color:#9ca3af;font-size:12px;line-height:1.6;">
                You're receiving this because your consultant submitted feedback on one of your essays.<br />
                Log in to Noga to review it.
              </p>
            </td>
          </tr>
  ...
  try {
    ...
    const res = await fetch("https://api.resend.com/emails", {
      ...
      body: JSON.stringify({
        ...
        to: studentEmail,
        subject: `${counselorName} left feedback on your essay — Noga`,
        html,
      }),
    });
