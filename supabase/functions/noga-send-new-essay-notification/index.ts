            ...
            <td style="padding:40px;">
              ...
              <div style="background:#f9fafb;border:1px solid #e5e7eb;border-radius:10px;padding:20px 24px;margin-bottom:28px;">
                <table cellpadding="0" cellspacing="0" width="100%">
                  ...
                  <tr>
                    <td style="padding:8px 0;border-bottom:1px solid #e5e7eb;">
                      <span style="color:#6b7280;font-size:12px;font-weight:600;text-transform:uppercase;letter-spacing:0.05em;">Context</span><br />
              ...
              <p style="margin:0 0 28px;color:#374151;font-size:14px;line-height:1.7;">
                Review the essay, leave your feedback, and send it back when ready.
              </p>
          ...
          <tr>
            <td style="background:#f9fafb;border-top:1px solid #e5e7eb;padding:20px 40px;text-align:center;">
              <p style="margin:0;color:#9ca3af;font-size:12px;line-height:1.6;">
                You're receiving this because one of your students submitted an essay for review on Noga.
              </p>
            </td>
          </tr>
...
serve(async (req) => {
  ...
  try {
    ...
    const baseUrl = appUrl || "https://consultant.primrosecrm.com";
    const html = newEssayHtml(
      counselorName,
      studentName,
      essayLabel,
      applicationName || "Essay",
      deadline || "",
      baseUrl,
    );
    ...
    const res = await fetch("https://api.resend.com/emails", {
      ...
      body: JSON.stringify({
        from: "Noga <team@primrosecrm.com>",
        to: counselorEmail,
        subject: `${studentName} submitted a new essay for review — Noga`,
        html,
      }),
    });
