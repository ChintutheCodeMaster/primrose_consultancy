...
export function getProgramTerms(degreeType?: string | null): ProgramTerms {
  ...
  if (t === '' || t === 'bachelor' || t === 'bachelors' || t === 'undergrad' || t === 'undergraduate') {
    return {
      ...
      Noun: 'University',
      NounPlural: 'Universities',
      sectionTitle: 'My Universities',
      navLabel: 'My Universities',
      addLabel: 'Add university',
      namePlaceholder: 'e.g. Brown University',
      listSubtitle:
        "Your working list, organized by reach. Add universities you're considering — your consultant will see them too.",
      listPhaseLabel: 'Building your list',
      listStageLabel: 'University list',
      testSectionTitle: 'Academics',
      academicsSubtitle: 'Numbers help us right-size your university list.',
