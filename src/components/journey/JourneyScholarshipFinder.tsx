...
const ScholarshipCard = ({
  match, isSaved, onSave, onViewDetails,
}: {
  match: EnrichedMatch;
  isSaved: boolean;
  onSave: () => void;
...
export function JourneyScholarshipFinder() {
  const {
    profile,
    searchState,
    savedIds,
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-violet-50/20 to-indigo-50/30 rounded-2xl">

      <div className="bg-gradient-to-br from-amber-50 via-white to-orange-50 border-b border-amber-100 px-6 py-10 rounded-t-2xl">
